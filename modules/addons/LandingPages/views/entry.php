@start('header')
    ...
    {{ $app->assets(['landingpages:assets/landingpages.js','landingpages:assets/js/entry.js'], $app['cockpit/version']) }}
            ...
            <div class="uk-width-medium-3-4">
                <div class="app-panel">
                    ...
                    <div class="uk-form-row">
                        ...
                        <a href="@route('/landingpages/entries/'.$collection["_id"])" >@lang('Cancel')</a>
                    </div>
