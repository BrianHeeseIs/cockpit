@start('header')
    ...
    {{ $app->assets(['landingpages:assets/landingpages.js','landingpages:assets/js/index.js'], $app['cockpit/version']) }}
...
<div data-ng-controller="landingpages" ng-cloak>

    <nav class="uk-navbar uk-margin-large-bottom">
        <span class="uk-hidden-small uk-navbar-brand">@lang('LandingPages')</span>
        <div class="uk-hidden-small uk-navbar-content" data-ng-show="landingpages && landingpages.length">
    ...
    <div class="uk-grid uk-grid-divider" data-uk-grid-match data-ng-show="landingpages && landingpages.length" data-uk-grid-margin>

        <div class="uk-width-medium-1-4">
            <div class="uk-panel">
                <ul class="uk-nav uk-nav-side uk-nav-plain" ng-show="groups.length">
                    <li class="uk-nav-header">@lang("Groups")</li>
                    <li ng-class="activegroup=='-all' ? 'uk-active':''" ng-click="(activegroup='-all')"><a>@lang("All landingpages")</a></li>
                </ul>
                ...
                <div class="uk-text-muted" ng-show="!groups.length">
                    @lang('Create groups to organize your landingpages.')
                </div>
        ...
        <div class="uk-width-medium-3-4">
            ...
            <div class="uk-margin-bottom">
                <span class="uk-badge app-badge">@@ (activegroup=='-all' ? '@lang("All landingpages")' : activegroup) @@</span>
            </div>

            <div class="uk-grid uk-grid-small" data-uk-grid-match data-ng-if="landingpages && landingpages.length && mode=='list'">
                <div class="uk-width-1-1 uk-width-medium-1-3 uk-grid-margin" data-ng-repeat="collection in landingpages track by collection._id" data-ng-show="matchName(collection.name) && inGroup(collection.group)">

                    <div class="app-panel">

                        <a class="uk-link-muted" href="@route('/landingpages/entries')/@@ collection._id @@"><strong>@@ collection.name @@</strong></a>
                            ...
                            <div class="uk-link" data-uk-dropdown="{mode:'click'}">
                                ...
                                <div class="uk-dropdown">
                                    <ul class="uk-nav uk-nav-dropdown uk-nav-parent-icon">
                                        ...
                                        <li><a href="@route('/landingpages/entries')/@@ collection._id @@"><i class="uk-icon-list"></i> @lang('Show entries')</a></li>
            ...
            <div class="app-panel" data-ng-if="landingpages && landingpages.length && mode=='table'">
                <table class="uk-table uk-table-striped" multiple-select="{model:landingpages}">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr class="js-multiple-select" data-ng-repeat="collection in landingpages track by collection._id" data-ng-show="matchName(collection.name) && inGroup(collection.group)">
    ...
    <div class="uk-text-center app-panel" data-ng-show="landingpages && !landingpages.length">
