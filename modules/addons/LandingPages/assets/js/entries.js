    ...
    App.module.controller("entries", function($scope, $rootScope, $http, $timeout){
        ...
        $scope.remove = function(index, entryId){
            App.Ui.confirm(App.i18n.get("Are you sure?"), function(){
                ...
                $http.post(App.route("/api/landingpages/removeentry"), {
        ...
        $scope.emptytable = function() {
            ...
            App.Ui.confirm(App.i18n.get("Are you sure?"), function() {
                $http.post(App.route("/api/landingpages/emptytable"), {
        ...
        var table = $("#entries-table").on("uk.sortable.change",function(){
            ...
            table.find('tbody').children().each(function(i){
                ...
                $http.post(App.route("/api/landingpages/saveentry"), {"collection": COLLECTION, "entry":entry, "createversion": false}).success(function(data){
